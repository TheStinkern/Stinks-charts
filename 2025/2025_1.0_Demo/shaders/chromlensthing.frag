...
// original effect is from here: https://www.shadertoy.com/view/4ttXWM
...
float distortion = 0.1;			// the bias of the barrel distortion
...
float separation = 0.2;			// how much to separate the r, g and b
